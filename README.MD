...
~We will not reboot now, but we will still reboot it manually to make sure UCSI register normally. Until you don't get~(With new hack, the UCSI driver is quiet reliable now, unlikely to meet these issues)
```
